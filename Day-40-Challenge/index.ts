...
while (countlog < 5) {       // This while loop runs until count is 5 times
  ...
  countlog++ }; // Increments count by 1

//Question 120: Use a for...of loop to iterate through an array of your favorite movies and log each one.

let favoriteMovies: string[] = ["Herry Potter","The Smurf","The Little SnowWhite","The Paradise"];
  for (let movies of favoriteMovies) {     // Uses a for...of loop to iterate through favoriteMovies
 console.log(movies)};
