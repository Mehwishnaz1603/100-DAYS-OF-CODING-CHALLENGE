...
// Initially, you will struggle and you will try to give up but that’s the moment when you need to have the patience to solve the questions. 
...
// brain to solve simple problems first then move to the next level or some complex problem. You can’t solve the mathematics problems of the
// 10th standard if your brain is not trained enough to solve the problems of the 9th standard. So don’t skip the question and move level by
// level in coding. 
